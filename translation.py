...
class TranslationBuilder(object):
    ...
    def _build_target_tokens(self, src, src_vocab, src_raw, pred, attn):
        if 'tea' in self.fields:
            tgt_field = dict(self.fields['tea'])['tgt'].base_field
        else:
    ...
    def from_batch(self, translation_batch):
        ...
        preds, pred_score, attn, align, gold_score, indices = list(
            zip(*sorted(zip(
                ...
                translation_batch["attention"], translation_batch["alignment"],
...
class Translation(object):
    ...
    __slots__ = [
        "src", "src_raw", "pred_sents", "attns", "pred_scores", "gold_sent",
        "gold_score", "word_aligns"
    ]

    def __init__(self, src, src_raw, pred_sents, attn, pred_scores, tgt_sent,
                 gold_score, word_aligns):
        self.src = src
